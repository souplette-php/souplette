...
final class InColumnGroup extends RuleSet
{
    public static function process(Token $token, TreeBuilder $tree)
    {
        ...
        } elseif ($type === TokenType::END_TAG && $token->name === 'colgroup') {
        ...
        } elseif ($type === TokenType::END_TAG && $token->name === 'col') {
            // TODO: Parse error.
            // Ignore the token
            return;
        } elseif (($type === TokenType::START_TAG || $type === TokenType::END_TAG) && $token->name === 'template') {
